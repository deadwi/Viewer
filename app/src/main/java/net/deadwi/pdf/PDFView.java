...
public class PDFView extends SurfaceView {
    ...
    private static final float PART_SIZE = 256;
    ...
    private int loadPage(final int userPage, final int nbOfPartsLoadable) {
        ...
        */
        ...
        final float partHeight = (PART_SIZE * ratioY) / zoom;
        final float partWidth = optimalPageWidth;//(PART_SIZE * ratioX) / zoom;
        ...
        class SpiralLoopListenerImpl implements SpiralLoopManager.SpiralLoopListener {
            ...
            public boolean onLoop(int row, int col) {
                ...
                float renderWidth = optimalPageWidth / relWidth;
                float renderHeight = PART_SIZE / relHeight;
                if (relX + relWidth > 1) {
                    relWidth = 1 - relX;
                }
                if (relY + relHeight > 1) {
                ...
                Log.d("pdf","rect : "+relX+" "+relY+" "+(relX + relWidth)+" "+(relY + relHeight));
    ...
    public void loadComplete(DecodeService decodeService) {
        ...
        state = State.LOADED;
        Log.d("pdf","Page size : "+pageWidth+" "+ pageHeight);
    ...
    private void calculateOptimalWidthAndHeight() {
        ...
        optimalPageWidth = w;
        optimalPageHeight = h;
        Log.d("pdf","optimalPage : "+optimalPageWidth+" "+optimalPageHeight);
